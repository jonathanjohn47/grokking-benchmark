...
# ======================================================================
# 4-HEAD VARIANT of plot_results.py.
#
# Loads and saves everything inside runs/four_head/, so it never touches
# the original single-head run's files in the project root (used by
# plot_results.py). Same plotting logic as plot_results.py, applied to
# the 4-head model's saved arrays.
# ======================================================================
...
ax.set_title("4-head model: Slow MA vs. Fast MA of Slow MA — Zero-Crossing Trigger", fontsize=13)
ax.legend(loc="upper right", fontsize=11)
ax.grid(True, alpha=0.3)

plt.tight_layout()
plt.savefig("ma_of_slow_ma_crossover.png", dpi=150, bbox_inches="tight")
print("[OK] Plot saved to runs/four_head/ma_of_slow_ma_crossover.png")
...
ax2.set_title("4-head model: Difference — Fast MA of Slow MA minus Slow MA", fontsize=13)
ax2.legend(loc="upper right", fontsize=11)
ax2.grid(True, alpha=0.3)

plt.tight_layout()
plt.savefig("ma_of_slow_ma_diff.png", dpi=150, bbox_inches="tight")
print("[OK] Plot saved to runs/four_head/ma_of_slow_ma_diff.png")
...
ax3.set_title("4-head model: Difference — Linear Scale", fontsize=13)
ax3.legend(loc="upper right", fontsize=11)
ax3.grid(True, alpha=0.3)

plt.tight_layout()
plt.savefig("ma_of_slow_ma_diff_linear.png", dpi=150, bbox_inches="tight")
print("[OK] Plot saved to runs/four_head/ma_of_slow_ma_diff_linear.png")
...
ax4.set_title(f"4-head model: MA-of-MA Difference vs. Grokking Curve — Grok epoch {grok_epoch}", fontsize=13)
...
print("[OK] Plot saved to runs/four_head/ma_of_ma_diff_vs_grokking_linear.png")
